    ...
    public static class LauncherLocalizer
    {
        ...
        static LauncherLocalizer()
        {
            ...
            var en = new Dictionary<string, string>
            {
                ...
                { ResolutionTooltip, "Internal render resolution. Values shown are display-equivalent; the game renders at 16:9 pixels and is stretched to your monitor's aspect ratio." },
                { RendererTooltip, "ReXGlue = original D3D12 presenter. Native = experimental DiligentCore/Vulkan presenter with GPU interop." },
            ...
            var es = new Dictionary<string, string>
            {
                ...
                { ResolutionTooltip, "Resolucion de renderizado interno. Los valores mostrados son equivalentes de pantalla; el juego renderiza a 16:9 y se estira a la relacion de aspecto de tu monitor." },
                { RendererTooltip, "ReXGlue = presentador D3D12 original. Native = presentador experimental DiligentCore/Vulkan con interop GPU." },
            ...
            var pt = new Dictionary<string, string>
            {
                ...
                { ResolutionTooltip, "Resolucao de renderizacao interna. Os valores mostrados sao equivalentes de tela; o jogo renderiza em 16:9 e e esticado para a proporcao do seu monitor." },
                { RendererTooltip, "ReXGlue = apresentador D3D12 original. Native = apresentador experimental DiligentCore/Vulkan com interop GPU." },
            ...
            var fr = new Dictionary<string, string>
            {
                ...
                { ResolutionTooltip, "Resolution de rendu interne. Les valeurs affichees sont des equivalents d'ecran; le jeu rend en 16:9 et est etire au format de votre moniteur." },
                { RendererTooltip, "ReXGlue = presentateur D3D12 original. Native = presentateur experimental DiligentCore/Vulkan avec interop GPU." },
